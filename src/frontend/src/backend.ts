...
import type { Chapter as _Chapter, ExternalBlob as _ExternalBlob, Manga as _Manga, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addChapter(arg0: bigint, arg1: string, arg2: Array<ExternalBlob>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addChapter(arg0, arg1, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addManga(arg0: string, arg1: string, arg2: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addManga(arg0, arg1, await to_candid_ExternalBlob_n9(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBookmarks(): Promise<Array<Manga>> {
        if (this.processError) {
            try {
    ...
    async getMangaById(arg0: bigint): Promise<Manga> {
        if (this.processError) {
            try {
                const result = await this.actor.getMangaById(arg0);
                return from_candid_Manga_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getMangaList(arg0: bigint): Promise<Array<Manga>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMangaList(arg0);
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReadingHistory(): Promise<Array<ReadingHistory>> {
        if (this.processError) {
            try {
    ...
    async recordReadingHistory(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordReadingHistory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchManga(arg0: string): Promise<Array<Manga>> {
        if (this.processError) {
            try {
    ...
    async updateManga(arg0: bigint, arg1: string, arg2: string, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateManga(arg0, arg1, arg2, await to_candid_ExternalBlob_n9(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Chapter_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Chapter): Promise<Chapter> {
...
async function from_candid_Manga_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Manga): Promise<Manga> {
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        coverImage: await from_candid_ExternalBlob_n15(_uploadFile, _downloadFile, value.coverImage),
        chapters: await from_candid_vec_n16(_uploadFile, _downloadFile, value.chapters)
    };
}
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Manga>): Promise<Array<Manga>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Manga_n13(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Chapter>): Promise<Array<Chapter>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Chapter_n17(_uploadFile, _downloadFile, x)));
}
